...
public class VendingMachineTest {
	...
	public void testAddItem_5()
			...
			fixture.addItem(item, code[0]);
			fixture.addItem(item, code[1]);
			fixture.addItem(item, code[2]);
			fixture.addItem(item, code[3]);
	...
	public void testMakePurchase_5()
		...
		fixture.balance = 1.0;
		String code = "A";
		VendingMachineItem item = new VendingMachineItem(null,1);
		fixture.addItem(item, code);
		boolean result = fixture.makePurchase(code);
